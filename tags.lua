...
local JSON_URL = "https://pastebin.com/raw/bESDzPcv"
local MAX_RETRIES = 3
...
local tagOrder = {"AL OWNER", "AL DEVELOPER", "AL GAMBLER", "AL BOOSTER", "AL SWASTIKA", "AL MANGO", "AL SIGMA", "AL GAY", "AL FART", "AL CHIPS", "AL RONALDU", "AL USER", "AL MZWSyn2", "AL danYT", "AL c00lkid"}
local playerToTag = {}
...
local RankData = {
    ...
    ["AL DEVELOPER"] = {
        ...
        emoji = "",
        image = "http://www.roblox.com/asset/?id=140013014943385"
    },
    ["AL GAMBLER"] = {
        primary = Color3.fromRGB(1, 1, 1),
        AnimateName = false,
        ...
        accent = ColorSequence.new {
            ...
            ColorSequenceKeypoint.new(0.33, Color3.fromRGB(50, 205, 50)),
            ColorSequenceKeypoint.new(0.66, Color3.fromRGB(34, 139, 34)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 100, 0))
        },
        emoji = "",
        image = "http://www.roblox.com/asset/?id=70439823774782"
    },
    ["AL BOOSTER"] = {
        primary = Color3.fromRGB(20, 20, 20),
        AnimateName = false,
